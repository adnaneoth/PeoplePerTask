      ...
      <div class="row d-flex align-items-center">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-center py-3">
          <div class="position-relative hero-img-container ">
            <img src="./images/heroimg.svg" alt="hero svg" id="hero-img-animation" class="mx-auto scale-hero-img"
              style="width: 40vw;">
            <img src="./images/flowerxl.svg" alt="flower" id="flower-img-animation"
              class=" position-absolute end-0 bottom-0 " style="width: 8vw;">
            <img src="./images/flowerm.svg" alt="icon" id="flower-small-animation" class=" position-absolute bottom-0  "
              style="width: 4vw;">
            <img src="./images/flowerxl.svg" alt="flower" id="flowerxl-img-animation"
              class=" position-absolute  bottom-0 end-100 " style="width: 8vw;">
            <img src="./images/Vectorsetting.svg" id="setting-icon-animation" alt="setting"
...
<section class="row m-2">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group">
              <label for="f_name">coment:</label>
              <input type="text" name="coment" class="form-control">
            </div>
            <div class="form-group">
              <!-- <label for="f_id_user">id:</label>
              <input type="text" name="coment_id" class="form-control">
            </div> -->
          </div>
          <div class="modal-footer">
            <input type="submit" class="btn btn-success" name="add_coment" value="Add">
          </div>Next
        </div>
      </div>
    </div>
  ...
  if (isset($_POST['add_coment'])) {
    ...
    if (empty($coment_id)) {
      ...
      $query = "INSERT INTO Testimoniales (commente, id) VALUES ('$coment', '$coment_id')";
      $result = mysqli_query($cnx, $query);
    }
